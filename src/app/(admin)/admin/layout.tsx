                ...
                <div className="flex h-full flex-col">
                    <div className="flex h-16 items-center justify-between border-b border-border px-4">
                        <Link href="/admin" className="flex items-center gap-2">
                            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-linear-to-br from-red-500 to-orange-500">
                        ...
                        <button onClick={() => setSidebarOpen(false)} className="lg:hidden rounded-lg p-1 hover:bg-muted cursor-pointer">
                            <X className="h-5 w-5" />
                        </button>
                    </div>
            ...
            <div className="flex flex-1 flex-col overflow-hidden">
                <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-border bg-card/80 backdrop-blur-md px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-4">
                        <button onClick={() => setSidebarOpen(true)} className="rounded-lg p-2 hover:bg-muted cursor-pointer lg:hidden">
                    ...
                    <div className="flex items-center gap-3">
                        <ThemeSelector className="h-10 w-32 text-xs" />
                        ...
                        <button
                            onClick={logout}
                            className="flex h-10 w-10 items-center justify-center rounded-xl bg-destructive/10 text-destructive hover:bg-destructive hover:text-white transition-all duration-200 cursor-pointer group"
                            title="Logout"
                        >
